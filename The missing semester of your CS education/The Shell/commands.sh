...
# (o)         : others
# (a, ugo)    : all
chmod hello.txt u+w  # Add "wirte" permission to the user
chmod hello.txt g-wx # remove "write", "execute" permissions from the groub
chmod hello.txt a=rw # Add "read", "write" permissions to all users and remove "execute" permission
